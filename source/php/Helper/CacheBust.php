...
namespace ModularityLinkCards\Helper;
 ...
 * 
 * @package ModularityLinkCards\Helper
 */
class CacheBust
{
     ...
     *
     * @param string $name The original filename (e.g., 'css/modularity-link-cards.css')
    ...
    private static function getManifest(): ?array
    {
        ...
        $manifestPath = MODULARITYLINKCARDS_PATH . 'assets/dist/manifest.json';
